...
export const career: Role[] = [
  ...
  },
  {
    ...
    startYear: 2025,
    context: "Brought on by an ex-colleague to consult for Swob's founders as they prepare for fundraising and enterprise sales. Stress-testing the product thesis, building functional prototypes, and advising on AI strategy informed by sales calls and investor feedback.",
    highlights: [
