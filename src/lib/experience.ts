...
export const career: Role[] = [
  {
    ...
    period: "2025 – Present",
    startYear: 2025,
    context: "Co-founded a studio to ship our own games. Collaborative model: small creative teams own their IP, studio handles ops, legal, and publishing.",
    highlights: [
      "Co-founded a collaborative game studio with a 70/30 revenue-share model where creators retain IP and creative control",
  ...
  },
  {
    ...
    startYear: 2024,
    context: "Instead of jumping back into the job market, I started building. Four products shipped in three months.",
    highlights: [
      ...
      "User research with 20+ users across all four products: validated problems before building",
    ],
