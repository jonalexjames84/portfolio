...
export const career: Role[] = [
  {
    ...
    highlights: [
      "Led business formation end-to-end: LLC incorporation, EIN registration, business banking, payment processing (Stripe, PayPal), contributor agreements, and IP assignment",
      "Built the 5-year financial model and investor materials: portfolio strategy scaling from 1 to 12 titles, $1.5M projected studio revenue, SAFE at $3M valuation cap with revenue-share hybrid options for non-dilutive investors",
      "Designed a phased go-to-market pipeline for Cluck: prototype launch and Steam wishlist push, Steam Next Fest demo, indie festival circuit (Day of the Devs, GDC, Tribeca), content creator partnerships, and a Kickstarter campaign targeting $75-150K",
      "Executing a multi-track fundraising strategy: $100K pre-seed via convertible SAFEs, non-dilutive grant applications (Epic MegaGrant, Wings Fund, Kowloon Nights), and a planned crowdfunding campaign aligned with demo milestones",
      "Leading product on Cluck, a 3D atmospheric horror-lite platformer with a 10+ person team, through a milestone-driven release: vertical slice, alpha with 3 levels, playtesting with retention metrics, then soft launch on Steam",
      "Wrote the 90-day operational execution plan covering business setup, MVP scoping, community engagement, scalability triggers, and post-launch live ops",
    ],
