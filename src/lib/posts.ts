...
export const posts: Post[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "He then showed a grid of eight prompt frameworks — each a structured approach to getting better output from your AI. The point wasn't to memorize all of them. It was to pick one or two that fit how you think, then build your prompt library around them.",

      "- **C-A-S-E** — Context (background info), Action (what you want done), Style (tone/format), Example (show what good looks like)\n- **R-I-S-E** — Role (persona for the AI), Input (information provided), Steps (process to follow), Expectation (desired output format)\n- **R-T-F** — Role, Task, Format. The most minimal — good for quick asks\n- **D-R-E-A-M** — Define (the objective), Research (relevant background), Execute (the task), Analyze (review output), Modify (refine). Best for complex multi-step research\n- **P-A-C-T** — Problem, Action, Context, Type (format of response)\n- **T-A-O** — Task, Action (specific steps), Output (expected result)\n- **S-O-L-V-E** — Situation (current state), Objective (goal), Limitations (constraints), Vision (desired outcome), Execution\n- **R-A-C-E** — Role, Action, Context, Expectation. One of the most popular for PM work because it forces you to set clear expectations upfront",

      "He surfaced a LinkedIn post from a Chief Product Officer that landed with the room: PMs are now expected to show their prompt library in interviews. \"What's in your prompt library?\" is the new \"walk me through your roadmap process.\"",
  ...
  },
  {
    ...
    date: "2026-02-28",
    tags: ["AI", "Ceramics", "Building", "Community"],
    content: [
      ...
      "![Onboarding](/screenshots/potteryfriends-welcome-members.jpg \"phone\") | ![Messaging](/screenshots/potteryfriends-messages.jpg \"phone\") | ![Social Feed](/screenshots/potteryfriends-feed.jpg \"phone\")",
      ...
      "![Forums](/screenshots/potteryfriends-forum.jpg \"phone\") | ![Events](/screenshots/potteryfriends-event-detail.jpg \"phone\") | ![Glaze Library](/screenshots/potteryfriends-glaze-library.jpg \"phone\")",
  ...
  },
  {
    ...
    date: "2026-02-26",
    tags: ["AI", "Product Management", "Workflow", "Building"],
    content: [
